...
{
    return fileSystem->Open_in_filesys(filename);     //"Open" in fileSystem still not define yet 
}

int Kernel::WriteFile(char *buffer, int size, OpenFileId id)
{
    return fileSystem->Write_in_filesys(buffer, size, id); //"Write" in fileSystem still not define yet
}

int Kernel::ReadFile(char *buffer, int size, OpenFileId id)
{
    return fileSystem->Read_in_filesys(buffer, size, id);  //"Read" in fileSystem still not define yet
}

int Kernel::CloseFile(OpenFileId id)
{
    return fileSystem->Close_in_filesys(id);  //"Close" in fileSystem still not define yet
} 
